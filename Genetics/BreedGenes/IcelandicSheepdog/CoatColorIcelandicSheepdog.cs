...
public class CoatColorIcelandicSheepdog : GeneInformationAbstract
{
    ...
    protected override void GenerateAlleles()
    {
        ...
        this.AddAllele(new('w', "Cream and White", 10));

        //Off standard colors
        this.AddAllele(new('h', "White", 5));
        ...
        this.AddAllele(new('d', "Chocolate and Tan", 88));

        //Unethical colors
        this.AddAllele(new('q', "Brindle", 92));
        this.AddAllele(new('j', "Blue", 68));
        this.AddAllele(new('k', "Red Merle", 28));
        this.AddAllele(new('z', "Blue Merle", 69));
        this.AddAllele(new('i', "Albino", 0));
