...
public class GeneticOptionsIcelandicSheepdog : GeneticsOptionsAbstract
{
    protected override void GenerateGenes()
    {
        ...
        this.AddGene(IcelandicSheepdogGeneName.Friendliness, new FriendlinessIcelandicSheepdog());
        this.AddGene(IcelandicSheepdogGeneName.Playfulness, new Playfulness());
        this.AddGene(IcelandicSheepdogGeneName.Adaptability, new AdaptabilityIcelandicSheepdog());
        ...
        this.AddGene(IcelandicSheepdogGeneName.Confidence, new ConfidenceIcelandicSheepdog());
        this.AddGene(IcelandicSheepdogGeneName.AffinityForHerding, new AffinityForHerdingIcelandicSheepdog());
